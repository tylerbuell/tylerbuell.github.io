  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container"> <button class="navbar-toggler navbar-toggler-right border-0" type="button" data-toggle="collapse" data-target="#navbar12">
      ...
      <div class="collapse navbar-collapse" id="navbar12"> <a class="navbar-brand d-none d-md-block" href="index.php">
        ...
        <ul class="navbar-nav">
          <li class="nav-item"> <a class="nav-link" name="logout" href="login.php?logout= '1'">Log out(<?php if($_SESSION['is_admin']){echo "[Admin]".$_SESSION['username'].")";}else{echo $_SESSION['username'].")";} ?></a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 rounded rounded-left rounded-right rounded-top rounded-bottom border-light border border-left border-right border-top border-bottom bg-dark" style="">
          <h3 class="display-3 text-center text-capitalize text-light bg-dark"><b>My Posts</b></h3>
        </div>
      </div>
    </div>
  </div>
