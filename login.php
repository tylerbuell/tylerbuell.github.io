        ...
        <div class="p-5 col-lg-6 col-10 mx-auto border">
          ...
          <form method="POST" action="login.php">
            ...
            <div class="form-group"> <input type="password" class="form-control" placeholder="Password" name="password">
              ...
              </small><small class="form-text text-muted text-right">
                <a href="chngpassword.php"> Forgot Password</a>
              </small>
            </div> <button type="submit" class="btn btn-primary" name="loginBtn">Login</button>
          </form>
        </div>
      </div>
    </div>
